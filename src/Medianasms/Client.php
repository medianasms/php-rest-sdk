...
namespace Medianasms;

use Exception;
use Medianasms\Models\InboxMessage;
use Medianasms\Models\Message;
use Medianasms\Models\PaginationInfo;
use Medianasms\Models\Pattern;
use Medianasms\Models\Recipient;
...
class Client
{
     ...
     * @var string
     */
    const ENDPOINT = "http://rest.medianasms.com";
    ...
    public function __construct($apiKey, $httpClient = null)
    {
        ...
        $userAgent = sprintf("MedianaSMS/ApiClient/%s PHP/%s",  self::CLIENT_VERSION, phpversion());
